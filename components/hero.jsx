                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center min-h-[80vh]">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <div className='flex gap-3 items-center'>
                            <button onClick={() => scrollToSection("contact")} className="inline-flex items-center bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 md:py-4 px-6 md:px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 shadow-lg cursor-pointer">
                                Contact Us
                            </button>
                            <button onClick={() => scrollToSection("services")} className="inline-flex items-center bg-transparent border-2 border-white text-white font-bold py-3 md:py-4 px-6 md:px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 shadow-lg cursor-pointer">
                                Our Services
                            </button>
                        </div>
                    </div>
